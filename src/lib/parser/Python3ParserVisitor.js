...
export default class Python3ParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitStar_named_expression(ctx) {
	  return this.visitChildren(ctx);
	}
